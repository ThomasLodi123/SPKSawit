                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('alternatives.update', $alternative->id)}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <label for="name">Umur Tanaman :</label>
                                    <div class="input-group">
                                        <input id="name" type="text" class="form-control" placeholder="e.g. Speed"
                                            name="name" value="{{ $alternative->name }}" disabled>
                                    </div>
                                    <div class="form-group">
                                    <label for="name">Jumlah Pelepah :</label>
                                    <div class="input-group">
                                        <input id="name" type="text" class="form-control" placeholder="e.g. Speed"
                                            name="name" value="{{ $alternative->name }}" disabled>
                                    </div>
                                    <div class="form-group">
                                    <label for="name">Tinggi Tanaman :</label>
                                    <div class="input-group">
                                        <input id="name" type="text" class="form-control" placeholder="e.g. Speed"
                                            name="name" value="{{ $alternative->name }}" disabled>
                                    </div>
                                    <div class="form-group">
                                    <label for="name">Diameter Tanaman :</label>
                                    <div class="input-group">
                                        <input id="name" type="text" class="form-control" placeholder="e.g. Speed"
                                            name="name" value="{{ $alternative->name }}" disabled>
                                    </div>
                                    <div class="form-group">
                                    <label for="name">Panjang Helaian Daun :</label>
                                    <div class="input-group">
                                        <input id="name" type="text" class="form-control" placeholder="e.g. Speed"
                                            name="name" value="{{ $alternative->name }}" disabled>
                                    </div>
